...
PICS = (environ.get('PICS', 'https://graph.org//file/ff703ad1511627a3f41f5.jpg')).split()
...
# Welcome area
MELCOW_IMG = environ.get('MELCOW_IMG',"https://graph.org//file/ff703ad1511627a3f41f5.jpg")
...
S_GROUP = environ.get('S_GROUP',"https://t.me/+Umb76mFKjis3MzU9")
MAIN_CHANNEL = environ.get('MAIN_CHANNEL',"https://t.me/Sachinkpt")
...
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE","<b>Request : {query} \n🏷 Title: <a href={url}>{title}</a>\n🎭 Genres: {genres}\n📆 Year: <a href={url}/releaseinfo>{year}</a>\n🌟 Rating: <a href={url}/ratings>{rating}</a></b>")
